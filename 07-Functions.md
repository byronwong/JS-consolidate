...
> https://javascriptweblog.wordpress.com/2010/07/06/function-declarations-vs-function-expressions/ > http://www.adequatelygood.com/JavaScript-Scoping-and-Hoisting.html
...
### Regarding inner functions and this
...
var myFunc1 = function () {
  ...
  // var that = this; // Old work around
  var myFunc2 = function () {
    // console.log(that.name); // returns bar
